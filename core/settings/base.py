...
ALLOWED_HOSTS = [
"www.sport-tta.online", "sport-tta.online", "127.0.0.1", "localhost"
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "TTA Sport Club",
    "site_header": "Sport-tta Adminstarator",
    "site_title": "Sport-tta Adminstrator",
}
